    ...
    <div className="mt-16 text-darker">
      ...
      <div className="flex flex-col text-2xl text-left p-10 items-center">
        ...
        <div className="mt-10 py-5 bg-dark text-offwhite w-full">
          <div className="text-center text-4xl">{Text.heading}</div>
        </div>
        ...
        <div className="pt-10 w-full text-left text-3xl">{Text.threatTitle}</div>
        ...
        <div className="mt-10 py-5 bg-dark text-offwhite w-full">
          <div className="text-center text-4xl">{Text.section}</div>
        </div>
        <div className="pt-10 text-left w-full text-3xl">{Text.impactTitle}</div>
        ...
        <div className="pt-10 text-3xl">{Text.hope}</div>
