...
const Text = {
  ...
  threats: ['Despite the efforts of these federal agencies, sea turtles face many threats, including:',
    '1. Fisheries bycatch',
  ...
  impact: ['Ocean plastic pollution can negatively impact sea turtles in 4 main ways:',
