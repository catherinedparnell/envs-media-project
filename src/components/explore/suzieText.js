...
const Text = {
  ...
  ingestion: 'The main concern with microplastics is ingestion by wildlife when the small particles are easily mistaken for food. Organisms can ingest microplastics through three main mechanisms: uptake by filter feeders, swallowing from surrounding water, or consuming other organisms that have already ingested microplastics.',
