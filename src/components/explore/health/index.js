...
export default function Health() {
  return (
    <div className="mt-16 bg-offwhite text-darker relative">
      <NavBar />
      <div className="flex flex-col text-2xl text-left p-10 items-center">
        <div className="py-5 bg-dark text-offwhite w-full">
          <div className="text-center uppercase text-4xl">Plastic &amp; Human health</div>
        </div>
        <div className="w-full text-3xl pt-10">{Text.microplastic}</div>
        <img src="../../../images/particlecategorytable.png" alt="table" className="h-3/5 w-3/5 mt-10" />
        <div className="w-full text-3xl pt-10">{Text.harmful}</div>
        ...
        <div className="w-full text-3xl pt-10">{Text.question}</div>
        ...
        <div className="w-full text-3xl pt-10">{Text.biomagnification}</div>
        ...
        <div className="w-full mt-10 p-10 bg-yellow container">
          <div className="text-3xl">{Text.you}</div>
        </div>
      </div>
    </div>
  );
