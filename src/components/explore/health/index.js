...
import ParticleCategoryTable from '../../../../images/particlecategorytable.png';
import CrabwordBubble from '../../../../images/crabwordbubble.png';
import MicroplasticHealth from '../../../../images/microplastichealth.png';
import FoodChain from '../../../../images/foodchain.png';
import PlateOfMussels from '../../../../images/plateofmussels.png';
  ...
  return (
    <div className="mt-16 bg-offwhite text-darker relative thin">
      ...
      <div className="flex flex-col text-2xl text-left p-10 items-center">
        ...
        <img src={ParticleCategoryTable} alt="table" className="h-3/5 w-3/5 mt-10" />
        <div className="w-full font-bold text-3xl pt-10">{Text.harmful}</div>
        <div className="w-full pt-10">{Text.ingestion}</div>
        <div className="flex w-full justify-evenly">
          <img src={CrabwordBubble} alt="table" className="h-2/5 w-2/5 mt-10 p-10" />
          <img src={MicroplasticHealth} alt="table" className="h-2/5 w-2/5 mt-10" />
        </div>
        ...
        <img src={FoodChain} alt="table" className="mt-10" />
        <div className="w-full pt-10">{Text.plate}</div>
        <img src={PlateOfMussels} alt="table" className="h-1/5 w-1/5 mt-10" />
