...
const Text = {
  ...
  long: 'Plastic that make their way into the ocean have a tendency to stay there for a long, long time. Their buoyancy allows them to float along the ocean\'s surface, transported by winds and surface currents.',
  macroplastic: 'There are currently an estimated 2,334 tons of macroplastics just in the world\'s surface oceans. Macroplastics are pieces of plastic that are larger than 5 mm in diameter.',
  graphmacroTitle: 'Estimated weight of macroplastics in tons',
  patch: 'Plastics tend to gather toward the center of ocean basins rather than coastal regions. The most famous large accumulation of plastic in our oceans\' surface waters is the Great Pacific Garbage Patch (GPGP). This enormous patch of garbage spans almost 700 million square miles, an area slightly larger than Alaska, the United States/’ largest state. The patch lies in the area between Hawaii and California and contains 1.8 trillion pieces of plastic that weigh a total of 79,000 tons.',
